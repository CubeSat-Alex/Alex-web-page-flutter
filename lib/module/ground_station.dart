    ...
    return Padding(
      ...
      child: Column(
        ...
        children:  [
          ...
          const SizedBox(height: 15),
          Center(child: Image.asset('images/groundStation/dashboard.png',width: 800,height: 500,)),
          ...
          Center(child: Image.asset('images/groundStation/sun.png',width: 800,height: 450,)),
          ...
          Center(child: Image.asset('images/groundStation/session.png',width: 800,height: 600,)),
          ...
          Center(child: Image.asset('images/groundStation/command.png',width: 800,height: 470,)),
          const SizedBox(height: 15),
          ...
          Center(child: Image.asset('images/groundStation/long-term.png',width: 800,height: 600,)),
          ...
          Center(child: Image.asset('images/groundStation/payload.png',width: 800,height: 500,)),
          ...
          Center(child: Image.asset('images/groundStation/logs.png',width: 800,height: 500,)),
